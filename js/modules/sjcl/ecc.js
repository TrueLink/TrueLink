define(["modules/sjcl/sjcl"], function (sjcl){
  "use strict";
  var ecc = {};
  ...
  ecc.pointJac.prototype = {
    ...
    mult: function (k, affine) {
      ...
      var i, j, out = new ecc.point(this.curve).toJac(), multiples = affine.multiples();
    ...
    mult2: function (k1, affine, k2, affine2) {
      ...
      var i, j, out = new ecc.point(this.curve).toJac(), m1 = affine.multiples(),
  ...
  ecc.curve.prototype.fromBits = function (bits) {
    var w = sjcl.bitArray, l = this.field.prototype.exponent + 7 & -8,
        p = new ecc.point(this, this.field.fromBits(w.bitSlice(bits, 0, l)),
  ...
  ecc._dh = function (cn) {
    ecc[cn] = {
      ...
      generateKeys: function (curve, paranoia, sec) {
        ...
        return { pub: new ecc[cn].publicKey(curve, pub),
