/* Big endian
  ...
  0x-1FE00 == [0, FE, 2, 0]
*/
define(["modules/sjcl/sjcl", "modules/sjcl/bitArray", "modules/sjcl/random"], function (sjcl){
  "use strict";
  /**
   * @constructor
  ...
  bn.prototype = {
    ...
    powermod: function (x, N) {
      var result = new bn(1), a = new bn(this), k = new bn(x);
      while (true) {
  ...
  bn.prime = {
    p127: bn.pseudoMersennePrime(127, [[0,-1]]),

    // Bernstein's prime for Curve25519
    p25519: bn.pseudoMersennePrime(255, [[0,-19]]),

    // NIST primes
    p192: bn.pseudoMersennePrime(192, [[0,-1],[64,-1]]),
    p224: bn.pseudoMersennePrime(224, [[0,1],[96,-1]]),
    p256: bn.pseudoMersennePrime(256, [[0,-1],[96,1],[192,1],[224,-1]]),
    p384: bn.pseudoMersennePrime(384, [[0,-1],[32,1],[96,-1],[128,-1]]),
    p521: bn.pseudoMersennePrime(521, [[0,-1]])
  };
