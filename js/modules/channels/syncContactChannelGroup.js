define([
    ...
    function SyncContactChannelGroup() {
        ...
        // just don't forget to set the dirtyNotifier after calling new SyncContactChannelGroup()
        ...
        // mirror of the contact's SyncContactChannelGroup to send tokens
    ...
    SyncContactChannelGroup.prototype = new Channel();
    ...
    $.extend(SyncContactChannelGroup.prototype, {
        ...
        //  User comms    //
        ////////////////////
        // user calls enterToken with SyncContactChannelGroup.GenerateTlkeToken argument
        ...
        // user calls enterToken with SyncContactChannelGroup.OfferToken argument
        ...
        // user calls enterToken with SyncContactChannelGroup.AuthToken argument
        ...
        sendMessage: function (data) {
            this._sendMessage(new SyncChannelGroupMessage(SyncChannelGroupMessage.MSG_TYPE_USER, data));
        },
        ...
        onChannelMessage: function (channel, data) {
            var message = SyncChannelGroupMessage.deserialize(data);
            if (message.type === SyncChannelGroupMessage.MSG_TYPE_USER) {
                this._emitUserMessage(message.data);
            } else if (message.type === SyncChannelGroupMessage.MSG_TYPE_WRAPPER) {
        ...
        onRemoteChannelSendPacket: function (channel, packet) {
            ...
            this._sendMessage(new SyncChannelGroupMessage(SyncChannelGroupMessage.MSG_TYPE_WRAPPER, packet, sender.ref));
        },
        ...
        onRemoteChannelToken: function (channel, token, context) {
            ...
            if ((token instanceof tokens.ContactChannelGroup.OfferToken) && ref === 0) {
                // remote SyncContactChannelGroup has provided an offer to accept
        ...
        _sendMessage: function (message, channel) {
            ...
            if (!(message instanceof SyncChannelGroupMessage)) {
    ...
    function SyncChannelGroupMessage(type, data, ref) {
        if (!$.isPlainObject(data)) {
            var msg = "Could not create SyncChannelGroupMessage message from " + JSON.stringify(data) + ". ";
    ...
    SyncChannelGroupMessage.prototype.serialize = function () {
        var dto = {
            t: this.type,
            d: this.data
        };
    ...
    SyncChannelGroupMessage.deserialize = function (dto) {
        return new SyncChannelGroupMessage(dto.t, dto.d, dto.r);
    };

    SyncChannelGroupMessage.MSG_TYPE_USER = "u";
    SyncChannelGroupMessage.MSG_TYPE_WRAPPER = "w";
