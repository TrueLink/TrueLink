...
describe("True Link Group Rekeying", function() {
    ...
    before(function () {
        ...
        this.bobTlgr.acceptInvite(null, invite);   

        var aliceGJP = this.aliceTlgr.generateGroupJoinPackage();
        var bobGJP = this.bobTlgr.generateGroupJoinPackage();
        this.aliceTlgr.processGroupJoinPackage(bobGJP.gjp);
        this.bobTlgr.processGroupJoinPackage(aliceGJP.gjp);

        aliceGJP.hashActivator.call();
        bobGJP.hashActivator.call();
    ...
    it("should send public messages", function() {
        ...
        var received = this.bobTlgr.unhash(this.bobTlgr.decrypt(packet));
    ...
    it("should send private messages", function() {
        ...
        var decrypted_packet_with_sender = this.bobTlgr.unhash(this.bobTlgr.decrypt(encrypted_packet));
